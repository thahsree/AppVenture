...
const projectsData: Record<string, {
  ...
  "fintech-dashboard": {
    ...
    solution: "We engineered a highly optimized architecture combining Next.js App Router, an intensive Redis caching layer, and a TimescaleDB backend to aggregate data efficiently. The frontend utilizes WebSockets for live data streaming directly into lightweight financial charts.",
    technologies: ["Next.js", "TypeScript", "Tailwind CSS", "TimescaleDB", "Redis", "Framer Motion"],
    results: [
  ...
  "healthconnect": {
    ...
    solution: "Developed a cross-platform React Native application integrating WebRTC for secure P2P video calls. We implemented end-to-end encryption for all medical records and chat messages, alongside a highly optimized signaling server to manage call handshakes rapidly.",
    technologies: ["React Native", "WebRTC", "Node.js", "PostgreSQL", "AWS HIPAA Cloud"],
    results: [
  ...
  "apex-ecommerce": {
    ...
    challenge: "The brand's legacy Shopify storefront was suffering from poor Core Web Vitals, resulting in lost search engine rankings and high bounce rates during peak sales events.",
    solution: "We migrated their infrastructure to a Headless Shopify setup using Next.js. We heavily optimized image delivery, implemented strategic edge caching, and redesigned the user flow to remove friction during checkout.",
    technologies: ["Next.js", "Shopify Storefront API", "Sanity CMS", "Vercel", "Tailwind CSS"],
    results: [
  ...
  "taskmaster": {
    ...
    solution: "We built an intuitive drag-and-drop workflow builder using React Flow. The backend relies on a scalable event-driven architecture using Kafka to execute user-defined multi-step automations asynchronously.",
    technologies: ["React", "Go", "Apache Kafka", "PostgreSQL", "React Flow", "Docker"],
    results: [
  ...
  "travel-companion": {
    ...
    solution: "We implemented an advanced local-first architecture using WatermelonDB for the mobile client, allowing full offline read/write access. We integrated an edge AI model to generate trip suggestions based on pre-downloaded city data.",
    technologies: ["React Native", "WatermelonDB", "OpenAI API", "Mapbox", "Node.js"],
    results: [
  ...
  "creative-portfolio": {
    ...
    solution: "We leveraged Three.js and React Three Fiber to build a custom particle-system based navigation. We implemented complex shader logic while ensuring heavy assets were progressively loaded and downgraded gracefully for less powerful devices.",
    technologies: ["Next.js", "Three.js", "React Three Fiber", "GSAP", "Lenis Scroll"],
    results: [
...
export default async function ProjectCaseStudy({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const project = projectsData[resolvedParams.slug] || {
    ...
    technologies: ["Next.js", "React", "Node.js", "Tailwind CSS", "TypeScript"],
    results: [
